...
<link rel="stylesheet" href="<%=request.getContextPath() %>/bower_components/html5-boilerplate/css/main.css">
-->

<!-- Modernizr JS -->
<!--
<script src="<%=request.getContextPath() %>/bower_components/html5-boilerplate/js/vendor/modernizr-2.6.2.min.js"></script>
-->